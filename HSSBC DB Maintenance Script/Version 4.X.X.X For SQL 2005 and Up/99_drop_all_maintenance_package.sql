...
drop procedure [dbo].[hsp_adhoc_backup_database]
GO


if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[hsp_calculate_next_run_time]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[hsp_calculate_next_run_time]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[hsp_differential_backup_database]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[hsp_differential_backup_database]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[hsp_get_disk_space]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[hsp_get_disk_space]
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[hsp_maint_log]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].hsp_maint_log
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[hsp_maint_schedule]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[hsp_maint_schedule]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[hsp_migrate_action]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].hsp_migrate_action
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[hsp_schedule_defaul_action]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[hsp_schedule_defaul_action]
GO

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[hsp_set_migrate_parameter]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[hsp_set_migrate_parameter]
GO


if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[hsp_shrink_log_file]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[hsp_shrink_log_file]
GO




if exists (select * from sysobjects where id = object_id(N'[dbo].[tbl_maint_parameter]') and xtype='U')
	drop table [dbo].[tbl_maint_parameter]
go


if exists (select * from sysobjects where id = object_id(N'[dbo].[tbl_maint_setting_v3]') and xtype='U')
	drop table [dbo].[tbl_maint_setting_v3]
go


if exists (select * from sysobjects where id = object_id(N'[dbo].[tbl_maint_action]') and xtype='U')
	drop table [dbo].tbl_maint_action
go


if exists (select * from sysobjects where id = object_id(N'[dbo].[tbl_dic_parameter]') and xtype='U')
	drop table [dbo].[tbl_dic_parameter]
go


if exists (select * from sysobjects where id = object_id(N'[dbo].[tbl_dic_freq_type]') and xtype='U')
	drop table [dbo].[tbl_dic_freq_type]
go

if exists (select * from sysobjects where id = object_id(N'[dbo].[tbl_dic_action]') and xtype='U')
	drop table [dbo].[tbl_dic_action]
go
