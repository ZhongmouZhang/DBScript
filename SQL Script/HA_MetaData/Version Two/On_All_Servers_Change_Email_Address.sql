...
---------------------------------------------------
--- Creates/update Database Services Operator  -----------
---------------------------------------------------
if exists (select * from msdb.dbo.sysoperators where name = 'Database Services')
	exec msdb.dbo.sp_update_operator @name = 'Database Services' , @email_address = 'HSSBCTSDatabaseServices@hssbc.ca'
else 	
