...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].hsp_FullBackupADB_V2') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].hsp_FullBackupADB_V2
GO
