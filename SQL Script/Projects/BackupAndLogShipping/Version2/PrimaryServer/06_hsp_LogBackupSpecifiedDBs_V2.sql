    if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].hsp_LogBackupSpecifiedDBs_V2') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].hsp_LogBackupSpecifiedDBs_V2
GO

-- hsp_LogBackupSpecifiedDBs '2007-05-15'
CREATE         proc dbo.hsp_LogBackupSpecifiedDBs_V2
@now datetime
as
