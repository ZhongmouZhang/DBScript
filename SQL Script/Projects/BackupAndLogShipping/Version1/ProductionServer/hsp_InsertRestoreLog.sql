...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].hsp_InsertRestoreLog') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].hsp_InsertRestoreLog
GO

CREATE         proc dbo.hsp_InsertRestoreLog
@dbname varchar(100),
...
set @stt = 'INSERT INTO [' + dbo.hfn_GetServerName( @Restore_FileName)
