...
set @folder = '\\SPDBSCAIS001\Backup_From_Production\for_recovery_restore\'  --temporary backup destination
...
where name not in ('tempdb','distribution','IHACAIS','MisysCAIS','cais','cht_trak','EDDS_Restore','profiler_tables')
