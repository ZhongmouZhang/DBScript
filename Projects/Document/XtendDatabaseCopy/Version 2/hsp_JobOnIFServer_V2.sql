...
/*************************************************
	step 0: find out the right backup file
*************************************************/
...
EXEC xp_cmdshell 'dir /B \\svmxtend01\Backup\'
     
SELECT top 1 @backupfile=line FROM #fileList 
WHERE line like  'XtendConsole_Full%'
ORDER BY right(line,19)

set @backupfile = '\\svmxtend01\Backup\' + @backupfile
...
begin
	...
	with move 'XtendConsole_Data' to 'C:\MSSQL\data\XtendConsole_data.mdf',
		 move 'XtendConsole_Log'  to 'C:\MSSQL\data\XtendConsole_log.ldf', replace, stats
...
with move 'XtendConsole_Data' to 'C:\MSSQL\data\temp_XtendConsole_data.mdf',
	 move 'XtendConsole_Log'  to 'C:\MSSQL\data\temp_XtendConsole_log.ldf', replace, stats
