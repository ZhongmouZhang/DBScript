...
begin
		-- it is time to fully backup the specified databases
		...
		-- it is time to fully backup the specified databases
		exec hsp_DiffBackupSpecifiedDBs_V2 @now -- it is time to fully backup the specified databases
		print 'exec hsp_DiffBackupSpecifiedDBs_V2'
